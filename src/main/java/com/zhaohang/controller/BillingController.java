...
import com.zhaohang.service.WebSocket;
...
//	@Scheduled(cron = "0/10 * * * * ?")
	...
	public Object testSM2() {
			...
			try {
				random = com.zhaohang.util.HttpUtil.sendPost("http://192.168.130.189:8081/zhaohangBilling/getRandom",param);
			System.out.println(random);
			System.out.println("进行签名");
			String signValue = com.zhaohang.util.PkiUtils.sign(random, "2222");
			...
			sendPost = com.zhaohang.util.HttpUtil.sendPost("http://192.168.130.189:8081/zhaohangBilling/getDetails",param);
